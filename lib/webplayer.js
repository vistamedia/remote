...
const READ_JS = "(function(){" + PICK
  ...
  + "c:location.pathname,h:location.hostname,t:titre});})()";
...
function forget() {
  current = { available: false, position: null, duration: null, playing: null, title: null, source: null, seekable: false };
  return current;
}
...
async function readNow(app) {
  ...
  current = {
    ...
    playing: data.j === 1,
    title: lu || TITRES.get(chemin) || null,
